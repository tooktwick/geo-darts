...
import { SniperGameState } from '../types';
      ...
      <div className="relative w-full max-w-2xl w-[92vw] max-h-[90vh] overflow-y-auto glass-panel-gold rounded-3xl p-5 md:p-8 border-amber-500/60 shadow-2xl text-center">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6 text-left">
          <div className="bg-slate-900/80 p-3.5 rounded-2xl border border-slate-800">
            <span className="text-[11px] text-slate-400 block font-semibold">最終スコア</span>
          ...
          <div className="bg-slate-900/80 p-3.5 rounded-2xl border border-slate-800">
            <span className="text-[11px] text-slate-400 block font-semibold">自己ベスト</span>
          ...
          <div className="bg-slate-900/80 p-3.5 rounded-2xl border border-slate-800">
            <span className="text-[11px] text-slate-400 block font-semibold">正解中率</span>
          ...
          <div className="bg-slate-900/80 p-3.5 rounded-2xl border border-slate-800">
            <span className="text-[11px] text-slate-400 block font-semibold">最大コンボ</span>
